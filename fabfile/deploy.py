...
from .utils import update_ambition_conf

django.settings_module('ambition.settings')

CONFIG_FILENAME = 'ambition.conf'
...
def deployment_host(bootstrap_path=None, release=None, skip_clone=None, skip_pip_download=None,
    ...
    Example:
        ...
        brew update && fab -H localhost deploy.deployment_host:bootstrap_path=/Users/erikvw/source/ambition/fabfile/conf/,release=develop,use_branch=True,bootstrap_branch=develop,skip_pip_download=True,skip_clone=True
...
def deploy_centralserver(**kwargs):
    """
        ...
        fab -H bhp066 deploy.deploy_centralserver:bootstrap_path=/Users/erikvw/source/ambition/fabfile/conf/,release=0.1.26,map_area=botswana --user=django
