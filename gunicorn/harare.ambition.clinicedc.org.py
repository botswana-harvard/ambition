...
loglevel = 'debug'
pidfile = os.path.join(SOURCE_ROOT, 'run/ambition-harare.pid')

workers = 2  # the number of recommended workers is '2 * number of CPUs + 1'

raw_env = [f'DJANGO_SETTINGS_MODULE=ambition.settings.production.harare']
