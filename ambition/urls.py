...
urlpatterns = [
    ...
    url(r'^admin/', ambition_rando_admin.urls),
    url(r'^admin/', edc_pharmacy_admin.urls),
    ...
    url(r'^edc_pharmacy/', include('edc_pharmacy.urls')),
    url(r'^edc_pharmacy_dashboard/', include('edc_pharmacy_dashboard.urls')),
